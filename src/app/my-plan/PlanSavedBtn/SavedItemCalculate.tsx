...
const SavedItemCalculate = () => {
    const { workoutSaved } = useContext(workoutContext);
    const calculatePlan = () => workoutSaved.reduce((acc, workout) => {
    ...
    return (
        <div className="bg-[#111319] border border-gray-800/80 rounded-2xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col space-y-2">
                ...
                <span className="text-4xl md:text-5xl font-black text-[#ccff00]">{workoutSaved.length}</span>
            </div>
...
export default SavedItemCalculate;